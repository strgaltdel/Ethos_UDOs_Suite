...
--	end
	...
	-- timer flight & Motor
	--			layoutApp				y1,y2,offset,	frame,theme,tmr#1,txt,tmr#2,txt
	top_timer(widget.layoutApp.topX1+2,Y1,Y2,Yoffset, frameX, 	theme, 1, 	TMR1txt,	2,	TMR2txt)

	-- switch stati
	--print("TopLayout: ",widget.layoutApp.width01)
	...
	-- model name	
	top_text(widget.layoutApp.topX4-5,Y1+5,Yoffset, frameX, theme,  widget.layoutApp,model.name(),theme.c_textGreen)	
