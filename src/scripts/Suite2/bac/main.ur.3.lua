...
local function create()
	...
	--xx loaded_chunk = assert(loadfile("/scripts/universal/uni_conf.lua"))
	loaded_chunk = assert(loadfile("/scripts/libUNow/suite/suite_conf.lua"))
	loaded_chunk()
	...
	--xx sensors = defineSensors()	
	--xx uniconf()			-- activate config
...
-- **********************************************    general layout    ******************************
		...
		--xx widget.topbarH 	= math.floor(widget.h *0.13)										-- height topbar
		widget.topbarH  = 01															-- 0= no topbar
		widget.spaceY  	= math.floor(widget.h*0.04)										-- space between topbar / widgets
